...
class TimeView(View):
    ...
    def view_config(self, max_dur):
        ...
        column_order = ["Change", "Merged_titles", "Begin", "End", "Duration", "Activity", "Subactivity", "Case", "Eisenhower"]
...
class ActiveWindowView(View):
    ...
    def view_config(self, max_dur):
        ...
        column_order = ["Change", "Merged_titles", "ID", "Duration", "Activity", "Subactivity", "Case", "Eisenhower"]
...
class ActivityView(View):
    ...
    def view_config(self, max_dur):
        ...
        column_order = ["Change", "Activity", "Subactivity", "Begin", "End", "ID", "Duration",  "Case", "Eisenhower"]
    ...
    def view_save(self, key, value):
        ...
        if key == "Eisenhower":
            df_original.loc[mask, "Change"] = False
